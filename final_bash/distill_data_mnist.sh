python main_distill.py --edge_update_frequency 3 \
--algorithm fed_distill_kip_limit --kip_support_size 10  --distill_iters 3000 \
--distill_data_path "distill_data_kip/"  --model mlp --weight_decay 1e-6  \
--task cifar10_cnum300_dist8_skew0.8_seed0 --sample uniform --num_edges 10  --num_clients 300 \
--num_rounds 300 --num_epochs 5 --learning_rate 0.001  --momentum 0.99 --proportion 0.5  \
--batch_size 64 --eval_interval 1 --gpu 1 --server_gpu_id 2 --num_threads 1  --learning_rate_decay 0.99 \
 --distill_ipc 10 --dropout_value=0.5

python main_distill.py --edge_update_frequency 6 \
--algorithm fed_distill_kip_limit --kip_support_size 10  --distill_iters 3000 \
--distill_data_path "distill_data_kip/"  --model mlp --weight_decay 1e-3  \
--task cifar10_cnum300_dist8_skew0.8_seed0 --sample uniform --num_edges 10  --num_clients 300 \
--num_rounds 300 --num_epochs 5 --learning_rate 0.001  --momentum 0.99 --proportion 0.5  \
--batch_size 64 --eval_interval 1 --gpu 1 --server_gpu_id 1 --num_threads 1  --learning_rate_decay 0.95 \
 --distill_ipc 10 --dropout_value=0.5
...
--distill_data_path "distill_data_kip/"  --model mlp --weight_decay 1e-6  \
--task cifar10_cnum300_dist8_skew0.8_seed0 --sample uniform --num_edges 10  --num_clients 300 \
--num_rounds 300 --num_epochs 5 --learning_rate 0.01  --momentum 0.99 --proportion 0.5  \
--batch_size 64 --eval_interval 1 --gpu 1 --server_gpu_id 1 --num_threads 1  --learning_rate_decay 0.9 \
 --distill_ipc 10 --dropout_value=0.5

python main_distill.py --edge_update_frequency 9 \
--algorithm fed_distill_kip_limit --kip_support_size 10  --distill_iters 3000 \
--distill_data_path "distill_data_kip/"  --model mlp --weight_decay 1e-6  \
--task cifar10_cnum300_dist8_skew0.8_seed0 --sample uniform --num_edges 10  --num_clients 300 \
--num_rounds 300 --num_epochs 5 --learning_rate 0.01  --momentum 0.99 --proportion 0.5  \
--batch_size 64 --eval_interval 1 --gpu 1 --server_gpu_id 0 --num_threads 1  --learning_rate_decay 0.9 \
 --distill_ipc 10 --dropout_value=0.5
