...
def read_option():
    ...
    parser.add_argument('--p_move', help='Probability of moving client', type=float, default=0.5)

    parser.add_argument('--mu_global', help='Mu value of global model for H2-Fed', type=float, default=0.001)
    parser.add_argument('--mu_edge', help='Mu value of local model for H2-Fed', type=float, default=0.01)
