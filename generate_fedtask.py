...
def read_option():
    ...
    parser.add_argument(
        '--dist', help='type of distribution;', type=int, default=0)
    parser.add_argument('--skew', help='the degree of niid;',
                        type=float, default=0.5)
    parser.add_argument(
        '--num_clients', help='the number of clients;', type=int, default=100)
    parser.add_argument('--number_class_per_client',
                        help='the number of classes per client;', type=int, default=2)
    try:
