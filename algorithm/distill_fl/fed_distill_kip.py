...
class MobileClient(BasicMobileClient):
    def __init__(self, option, name='', train_data=None, valid_data=None):
        ...
        self.distill_save_path = os.path.join(f'fedtask/{self.task_name}/', self.option['distill_data_path'], self.option['architec_KIP'], str(
            self.option['depth_KIP']), str(self.option['distill_ipc']))
        self.total_size = 0
