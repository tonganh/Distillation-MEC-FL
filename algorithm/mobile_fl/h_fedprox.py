...
class MobileClient(BasicMobileClient):
    ...
    def unpack(self, received_pkg):
        ...
        """
        # unpack the received package
        return received_pkg['model'], received_pkg['global_model']
    ...
    def reply(self, svr_pkg):
        ...
        """
        # print("In reply function of client")
        model, global_model = self.unpack(svr_pkg)
        # print("CLient unpacked to package")
    ...
    def train(self, model, global_model):
        # print(device)
        # global parameters
